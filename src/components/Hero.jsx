...
const Hero = (props) => {
    ...
    const handaleSelect =(selectedIndex)=>{
        ...
        <div className="container section-top">
            <div className="row">
                <div className="col-md-8 col-lg-8 col-sm-12 p-1 col-12">
                    <Carousel id="carouselHero" activeIndex={index} onSelect={handaleSelect} controls={false}>
                        {
                ...
                <div className="col-md-4 col-lg-4 col-sm-6 p-1 col-6">
                    <Link href={`/details?id=${props.featured[0]['id']}`} id='Hero' className="card h-100">
                        <img alt="image2" className="card-img-top w-100 rounded-2" src={props.featured[0]['img2']}/>
